...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/hamidw/instalasi/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/hamidw/permission/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/hamidw/instalasi/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/hamidw/instalasi/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
cd
    ...
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/hamidw/instalasi/main/encrypt/encrypt" ; chmod +x /usr/bin/enc
    7z x -phamidw12345 menu.zip
    chmod +x menu/*
    enc menu/*
...
SHELL=/bin/sh
PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
0 */1 * * * * root /usr/local/sbin/xraylimit
END
